# Generated by Django 2.1.5 on 2019-12-04 07:27
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(default='USD', max_length=255, unique=True)),
                ('symbol', models.CharField(default='USD', max_length=10, unique=True)),
